...
function verify_last() {
    let val1: HTMLInputElement = <HTMLInputElement> document.getElementById('x1-plot-val');
    let val2: HTMLInputElement = <HTMLInputElement> document.getElementById('x2-plot-val');
    let val3: HTMLInputElement = <HTMLInputElement> document.getElementById('y1-plot-val');
    let val4: HTMLInputElement = <HTMLInputElement> document.getElementById('y2-plot-val');
    let val5: HTMLInputElement = <HTMLInputElement> document.getElementById('slope-plot-val');
    let val6: HTMLInputElement = <HTMLInputElement> document.getElementById('plank-plot-val');
