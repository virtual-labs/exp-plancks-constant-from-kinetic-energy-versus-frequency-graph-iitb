...
function activity3() {
    ...
    pp.clearrightpannel();
    pp.addoffcanvas(3);
    pp.showtitle(`<p id="exp-title" style='width: 25vw;'>To determine the Planck's constant from kinetic energy versus frequency graph</span><p>`, 3);
    ...
    scene = new Scene();
    assembly_image = new Chemistry.Custome_image(assembly, new Chemistry.Point(1050, 450), 815 * 1.3, 635 * 1.3, canvas);
...
function start_with_key() {
    ...
    let ele2 = (document.getElementById('d-inp'));
    ele.disabled = false;
    ele2.disabled = false;
...
function set_lambda() {
    ...
    dsp.value = selected_lambda * Math.pow(10, 9) + ' nm';
