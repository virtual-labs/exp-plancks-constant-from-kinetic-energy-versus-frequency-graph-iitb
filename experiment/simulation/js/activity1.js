...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(ammeter, new Chemistry.Point(1000, 250), 194, 203, canvas);
    sq.name = 'ammeter';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(battery, new Chemistry.Point(1650, 250), 194, 128, canvas);
    sq.name = 'battery';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(one_way_key, new Chemistry.Point(1650, 750), 178, 90, canvas);
    sq.name = 'one_way_key';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(resistance, new Chemistry.Point(280, 750), 172, 34, canvas);
    sq.name = 'resistance';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(rheostat, new Chemistry.Point(280, 250), 342, 143, canvas);
    sq.name = 'rheostat';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(voltmeter, new Chemistry.Point(1000, 750), 194, 203, canvas);
    sq.name = 'voltmeter';
    scene.add(sq);
}
...
function a1_load_questions() { }
{
    ...
    question.push({
        srno: 1,
        question: "Select <span style='color: #018fc3'>Ammeter</span>",
        ans: 'ammeter',
        hint: [
    ...
    question.push({
        srno: 3,
        question: "Select <span style='color: #018fc3'> One Way Key </span>",
        ans: 'one_way_key',
        hint: ['Rectangular', 'Mounted Vertically', 'Has valves attached'],
    });
    question.push({
        srno: 4,
        question: "Select <span style='color: #018fc3'>Resistance</span>",
        ans: 'resistance',
        hint: [
            'Double Pipe',
            'pipe inside a pipe',
    ...
    question.push({
        srno: 5,
        question: "Select <span style='color: #018fc3'>Rheostat</span>",
        ans: 'rheostat',
...
function load_higlighted_images() {
    highlighted_images = [
        [ammeter, ammeter],
        [battery, battery],
        [one_way_key, one_way_key],
        [resistance, resistance],
        [rheostat, rheostat],
        [voltmeter, voltmeter],
    ];
    a1_labels = [
        new Chemistry.Text('ammeter', new Chemistry.Point(950, 100), canvas),
        new Chemistry.Text('battery', new Chemistry.Point(1615, 120), canvas),
        new Chemistry.Text('one way key', new Chemistry.Point(1583, 660), canvas),
        new Chemistry.Text('resistance', new Chemistry.Point(225, 690), canvas),
        new Chemistry.Text('rheostat', new Chemistry.Point(235, 190), canvas),
        new Chemistry.Text('voltmeter', new Chemistry.Point(950, 605), canvas),
    ];
}
